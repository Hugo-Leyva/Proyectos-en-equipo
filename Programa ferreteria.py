...
while True:
    ...
    if opcion == '1':
        ...
        if id_buscar in registro_ventas:
            ...
            print(f'{"Descripcion":<25} {"Cantidad":^10} {"Precio venta":^10} {"Precio total":>15}') #Los numeros en azul son parametros de espaciado entre cada string
            print(f'{"-----------":<25} {"--------":^10} {"------------":^10} {"------------":>15}') #Con el fin de que se sitúen justo arriba de los valores
            for articulo in registro_ventas[id_buscar]:
                print(f'{articulo[0]:<25} {articulo[1]:^10} {articulo[2]:^10.2f} {articulo[3]:>15.2f}') #se imprime cada articulo con un espacio entre ellos para alinearlos en forma tabular
