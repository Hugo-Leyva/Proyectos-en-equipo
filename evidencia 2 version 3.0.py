...
while True:
    ...
    if opcion == '1':
        ...
        #SE CONSULA LA VENTA MEDIANTE LA INSTRUCCION DE PANDAS, Y SE COMPARA LA COLUMNA FOLIO CON
        #LA VARIABLE venta EN DONDE INGRESAMOS LA VENTA A CONSULTAR. CON TRY, LE DECIMOS QUE SI ES IGUAL
        #A LA ENCONTRADA EN EL CSV, SE EJECUTA EL SIGUIENTE CÓDIGO, QUE RECUPERA LOS DATOS DE ESA VENTA.
        #SI NO SE ENCUENTRA MARCARÁ UN ERROR Y POR TANTO ENTRA AL EXCEPT, DICIENDO Folio no encontrado
        try:
